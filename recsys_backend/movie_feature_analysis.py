"""
    ...
    movie_feature_analysis.py \n
    by MARIO GABRIELE CAROFANO and OLEKSANDR SOSOVSKYY.

    Questo script carica la matrice sparsa movie-feature nel file NPZ,
    calcola il numero di film associati a ciascuna feature e genera un grafico
    della distribuzione "long-tail" utilizzando una scala log-log
...
def analizza_distribuzione_feature(matrix_path):
    ...
    #   ####################################################################    #
    #   CALCOLO DEL NUMERO DI FILM PER FEATURE
    ...
    #   ####################################################################    #
    #   4. Aggiungiamo una griglia per migliorare la leggibilità
